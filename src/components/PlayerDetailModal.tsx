          ...
          <div className="flex flex-wrap gap-2">
            {player.discord && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-[8px] px-2.5 h-7 text-[10px] font-bold tracking-wider uppercase bg-[#5865F2]/10 text-[#5865F2] border border-[#5865F2]/20 hover:bg-[#5865F2]/20 transition-all duration-150"
              >
            ...
            {player.twitter && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-[8px] px-2.5 h-7 text-[10px] font-bold tracking-wider uppercase bg-ink/5 text-ink-soft border border-border-faint hover:bg-ink/10 transition-all duration-150"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-3 w-3 shrink-0">
            ...
            {player.twitch && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-[8px] px-2.5 h-7 text-[10px] font-bold tracking-wider uppercase bg-[#9146FF]/10 text-[#9146FF] border border-[#9146FF]/20 hover:bg-[#9146FF]/20 transition-all duration-150"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-3 w-3 shrink-0">
            ...
            {player.instagram && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-[8px] px-2.5 h-7 text-[10px] font-bold tracking-wider uppercase bg-[#E4405F]/10 text-[#E4405F] border border-[#E4405F]/20 hover:bg-[#E4405F]/20 transition-all duration-150"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-3 w-3 shrink-0">
